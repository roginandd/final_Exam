...
const OrderForm = ({ addOrder, setMessage, setStatus }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await axios.post('http://localhost:8082/kopeetearia-api/add-order', newOrder);
        ...
        <table>
          ...
          <tbody>
            <tr>
              ...
              <td>
                <button className="button-radial" id="addOrderBtn" type="submit">Place Order</button>
              </td>
            </tr>
          </tbody>
        </table>
